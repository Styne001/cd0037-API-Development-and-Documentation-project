...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = (
            f"postgresql://postgres:Possible001#@localhost:5432/{self.database_name}"
        )
    ...
    def test_404_if_category_not_found(self):
        res = self.client().post(
            "/question", json={"question": 4353, "answer": True, "category": "3"}
        )
        data = json.loads(res.data)
    ...
    def test_create_new_questions(self):
        ...
        res = self.client().post(
            "/questions",
            json={
                "question": "Elon Musk's dog's name?",
                "answer": "flukky",
                "category": 5,
            },
        )
    ...
    def test_405_if_question_creation_is_not_allowed(self):
        res = self.client().post(
            "/questions/432", json={"question": 4353, "answer": True, "category": "3"}
        )
        data = json.loads(res.data)
